...
export const ROUTES: RouteEntry[] = [
  ...
  { ...m24, route: "/quantum-security", file: "app/(motion)/quantum-security/page.meta.ts" },
  { ...m25, route: "/research", file: "app/(site)/research/page.meta.ts" },
  { ...m26, route: "/solutions", file: "app/(site)/solutions/page.meta.ts" },
  { ...m27, route: "/terms-of-use", file: "app/(site)/terms-of-use/page.meta.ts" },
];
