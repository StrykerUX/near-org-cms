...
// `extended` acá. Ver components/sections/lab/DescentStairs.tsx.
export default async function DescentDPage({
  searchParams,
}: {
  searchParams: Promise<{ debug?: string }>;
}) {
  const { debug } = await searchParams;
  return <DescentStairs backdrop="extended" debug={debug !== undefined} />;
}
