...
//
// No es opcional para esta ruta: HeroVideo, QuantumBars, OwnYourOwn,
// NearStackV2 y ProofStepper miden contra el viewport, y sin el refresh
// coordinado del provider quedan ancladas a la altura del primer paint (antes
// de que carguen la fuente, el video y el SVG isométrico).
export default function HomepageAb7Layout({
  children,
}: {
