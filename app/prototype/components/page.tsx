...
function Meta({ children }: { children: string }) {
  return <p className="font-mono text-caption text-muted-foreground">{children}</p>;
}

const REFERENCE = [
  { name: "Accent", file: "primitives/Accent.tsx", props: "display?, children" },
  { name: "Button", file: "primitives/Button.tsx", props: "href?, variant?, icon?, className?" },
  { name: "Eyebrow", file: "primitives/Eyebrow.tsx", props: "className?, children" },
  { name: "Container", file: "primitives/Container.tsx", props: "as?, className?, children" },
];
...
<Accent>the open web</Accent>    // font-serif, H2–H4`}</code>
        ...
        <Meta>Accent · primitives/Accent.tsx · display?: boolean</Meta>
      </section>
...
<Button href="#" icon={<Play />}>Watch</Button>`}</code>
        ...
        <Meta>Button · primitives/Button.tsx · href?, variant?: "light"|"dark", icon?</Meta>
      </section>
...
<Eyebrow className="text-secondary-foreground/50">Vision</Eyebrow>`}</code>
        ...
        <Meta>Eyebrow · primitives/Eyebrow.tsx · className? (default: text-muted-foreground)</Meta>
      </section>
...
<Container as="nav" className="flex items-center justify-between">...</Container>`}</code>
        </pre>
        <Meta>Container · primitives/Container.tsx · as? (default: div), className?</Meta>
      </section>
