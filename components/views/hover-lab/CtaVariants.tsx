...
export const CTA_VARIANTS: CtaVariant[] = [
  {
    ...
    name: "Sweep",
    stack: ["CSS"],
    note: "What production ships today. Gradient at rest; hover moves the light instead of revealing anything. The baseline everything else is measured against.",
    Comp: () => <Cta v="sweep" />,
  },
  {
    id: "wipe",
    name: "Wipe",
    stack: ["CSS"],
    note: "The fill enters from the left and the label changes colour at the same rate (two clipped layers). The section CTA's gesture, at nav scale.",
    Comp: CtaWipe,
  },
  {
    id: "diagonal",
    name: "Diagonal",
    stack: ["CSS"],
    note: "The same wipe, cut at 18°. Faster to read than the straight one because the eye follows the tip of the diagonal.",
    Comp: () => <Cta v="diagonal" />,
  },
  {
    id: "iris",
    name: "Iris",
    stack: ["CSS"],
    note: "Grows from the centre, where the click would land. The most button-like of them all, and the slowest to reach the corners.",
    Comp: () => <Cta v="iris" />,
  },
  {
    id: "roll",
    name: "Label roll",
    stack: ["CSS"],
    note: "The text rolls out and its copy rolls in. No colour involved: useful when the green is already doing a job elsewhere in the bar.",
    Comp: CtaRoll,
  },
  {
    id: "conic",
    name: "Conic ring",
    stack: ["CSS"],
    note: "A gradient ring that spins. It needs @property to interpolate the angle — without it the rotation is a jump, not a spin.",
    Comp: () => <Cta v="conic" />,
  },
  {
    id: "glow",
    name: "Lift + glow",
    stack: ["CSS"],
    note: "1.5px of lift and a halo. The conservative option: it doesn't compete with the four tabs, the hamburger and the wordmark already in the bar.",
    Comp: () => <Cta v="glow" />,
  },
  {
    id: "press",
    name: "Press",
    stack: ["CSS"],
    note: "Minimal hover, :active does the talking. The only one here that says anything on touch screens, where :hover doesn't exist.",
    Comp: () => <Cta v="press" />,
  },
  {
    id: "shine",
    name: "Shine",
    stack: ["CSS"],
    note: "A specular band crossing once. On a loop it's an ad; fired by hover it's an answer.",
    Comp: () => <Cta v="shine" />,
  },
  {
    id: "stripes",
    name: "Stripes",
    stack: ["CSS"],
    note: "Ramp bars sweeping across. The only textured one — it holds up because the bar is flat black.",
    Comp: () => <Cta v="stripes" />,
  },
  {
    id: "shutter",
    name: "Shutter",
    stack: ["CSS"],
    note: "Two halves closing on the centre. A mechanical read, from the same vocabulary as the isometric art on the home page.",
    Comp: () => <Cta v="shutter" />,
  },
  {
    id: "rise",
    name: "Underline rise",
    stack: ["CSS"],
    note: "A 2px rule that grows into the whole button. A link dressed as a button: quiet at rest, explicit on hover.",
    Comp: () => <Cta v="rise" />,
  },
  {
    id: "corner",
    ...
    stack: ["CSS"],
    note: "The box reacts, not the colour: the radius tightens and the tracking opens. Padding compensates so the nav never reflows.",
    Comp: () => <Cta v="corner" />,
  },
  {
    id: "arrow",
    name: "Arrow reveal",
    stack: ["CSS"],
    note: "The only one that adds information — where it leads — instead of just confirming there's a button. The arrow's slot is already reserved.",
    Comp: CtaArrow,
  },
  {
    id: "dots",
    name: "Dither dots",
    stack: ["CSS"],
    note: "The fill arrives as a dither and closes up. A dot mask with its radius animated through @property.",
    Comp: () => <Cta v="dots" />,
  },
  {
    id: "inset",
    name: "Inset close",
    stack: ["CSS"],
    note: "Enters from all four edges at once, with a single animated clip-path. Symmetric, and stiller than it looks because of it.",
    Comp: () => <Cta v="inset" />,
  },
  {
    id: "spotlight",
    name: "Spotlight",
    stack: ["CSS", "JS"],
    note: "A halo tracking the cursor. JS writes --mx/--my and nothing else; the rest is CSS. No rAF anywhere.",
    Comp: CtaSpotlight,
  },
  {
    id: "direction",
    ...
    stack: ["CSS", "JS"],
    note: "The fill enters and leaves by the EDGE the pointer crossed. The one that best respects the whole gesture; costs 12 lines of JS.",
    Comp: CtaDirection,
  },
  {
    id: "tilt",
    name: "3D tilt",
    stack: ["CSS", "JS"],
    note: "Real perspective, with the highlight running against the tilt. 7° maximum: past that, 14px text goes soft.",
    Comp: CtaTilt,
  },
  {
    id: "magnetic",
    name: "Magnetic (rAF)",
    stack: ["JS"],
    note: "A hand-rolled lerp that shuts itself off on arrival. It measures the wrapper, not the button, or the magnet chases itself.",
    Comp: CtaMagnetic,
  },
  {
    id: "ripple",
    name: "Ripple (WAAPI)",
    stack: ["JS"],
    note: "Material Design, but fired by hover instead of click. The radius is computed to the farthest corner from the entry point.",
    Comp: CtaRipple,
  },
  {
    id: "scramble",
    name: "Scramble",
    stack: ["JS"],
    note: "The label resolves left to right. Fixed advance width and untouched spaces: without those, it's the effect that ages worst.",
    Comp: CtaScramble,
  },
  {
    id: "gsap-magnet",
    ...
    stack: ["GSAP"],
    note: "quickTo on the button and on the label at half speed, with an elastic return. The parallax is what gives it mass.",
    Comp: CtaGsapMagnet,
  },
  {
    id: "gsap-chars",
    name: "Char roll",
    stack: ["GSAP"],
    note: "SplitText: the line leaves letter by letter while the new one arrives. A paused timeline with play/reverse — flicking in and out queues nothing.",
    Comp: CtaGsapChars,
  },
  {
    id: "gsap-squash",
    name: "Squash & stretch",
    stack: ["GSAP"],
    note: "1.06 × 0.94: volume is preserved, which is what separates this from a plain scale. Elastic only on the way back.",
    Comp: CtaGsapSquash,
  },
  {
    id: "gsap-sparks",
    name: "Sparks",
    stack: ["GSAP"],
    note: "The celebratory end of the range. Right for a Claim or a Mint; almost certainly not for a header's permanent CTA.",
    Comp: CtaGsapSparks,
  },
  {
    id: "gsap-draw",
    name: "Outline draw",
    stack: ["GSAP"],
    note: "The outline draws itself with stroke-dasharray on an SVG rect. The length comes from getTotalLength(): a rounded rect isn't 2(w+h).",
    Comp: CtaGsapDraw,
  },
];
