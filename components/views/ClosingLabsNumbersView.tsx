...
import GridNumbers from "@/components/sections/closing-labs/grid/Numbers";
import RevealNumbers from "@/components/sections/closing-labs/reveal/Numbers";
import CardNumbers from "@/components/sections/closing-labs/card/Numbers";
import NightNumbers from "@/components/sections/closing-labs/night/Numbers";
import SlabNumbers from "@/components/sections/closing-labs/slab/Numbers";
...
export default function ClosingLabsNumbersView() {
  return (
    <main className="bg-cream">
      <header className="mx-auto flex w-full max-w-[1780px] flex-col gap-4 px-[60px] pb-16 pt-[calc(var(--site-header-block)+4rem)]">
        ...
        <h1 className="text-h1 max-w-[18ch] text-balance text-ink">Las seis pruebas</h1>
        <p className="text-body max-w-[62ch] text-ink/70 text-pretty">
          «100% uptime», «1.0 million TPS» y las cuatro que siguen. Hoy es `homepage-tuck/ProofLedger`: un renglón por prueba, la cifra a un tercio del bloque y el cuerpo colgado a la derecha.
        </p>
