...
// /prototype/homepage-i — duplicado de `/prototype/homepage-g`.
//
...
export default function HomepageIView() {
  return (
    <main className="flex flex-col bg-cream">
      ...
      {/* LO ÚNICO que distingue esta ruta de `/prototype/homepage-g`: cómo
          llega el negro — acá, el fondo se da vuelta en un frame, seco, sin transición. Todo lo demás, hero incluido, es
          idéntico. */}
      <StackOverture mode="cut" />
