import Hero from "@/components/sections/chain-ab-homepage-refined-2/Hero";
import WhyItMatters from "@/components/sections/chain-ab-homepage-refined-2/WhyItMatters";
import StickyScrollCapabilities from "@/components/sections/chain-ab-homepage-refined-2/StickyScrollCapabilities";
import Proof from "@/components/sections/chain-ab-homepage-refined-2/Proof";
...
// construye.
export default function ChainAbHomepageRefined2View() {
  return (
