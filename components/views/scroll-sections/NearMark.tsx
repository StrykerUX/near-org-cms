// The real NEAR symbol (public/prototype/v2/near-mark.svg), inlined so its
// fill can follow `currentColor` — the placeholder "N" glyph it replaces
// switched color per node state (inactive/active/past), which a static
// <Image> can't do.
export default function NearMark({ className }: { className?: string }) {
  return (
    <svg viewBox="108 108 351 351" className={className} aria-hidden="true">
      <path
        fill="currentColor"
