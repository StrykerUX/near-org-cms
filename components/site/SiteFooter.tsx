    ...
    <footer className="relative bg-[#575757] text-white">
      <div className="mx-auto w-full max-w-[1920px] px-5 sm:px-10 lg:px-[100px]">
        ...
        <div className="flex lg:hidden pt-16 pb-6">
          <span className="text-white text-[0.875rem] uppercase tracking-[0.2em]">Site</span>
        </div>
        ...
        <p className="text-[12px] lg:text-[14px] text-white/35 pt-4 pb-8 lg:py-8">© 2026. All Rights Reserved.</p>
