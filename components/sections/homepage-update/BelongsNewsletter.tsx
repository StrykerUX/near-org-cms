...
export default function BelongsNewsletter() {
  return (
    <section className="bg-cream py-16 text-foreground md:py-20" style={PALETTE}>
      <Container>
        ...
        <div className="rounded-[32px] bg-[var(--card-surface)] px-6 py-[7%] text-center sm:px-10">
          <div className="mx-auto flex max-w-2xl flex-col items-center">
            ...
            <Image
              src="/prototype/homepage-update/near-squircle.svg"
              alt=""
              aria-hidden="true"
              width={800}
              height={800}
            ...
            <h2 className="text-h2 sm:whitespace-nowrap">
            ...
            <p className="mt-1 max-w-lg text-body text-pretty">
