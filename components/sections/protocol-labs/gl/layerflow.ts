...
//
// Es la superficie del hero de Protocol A. Nació como el shader de una variante
// del laboratorio de aperturas y se copió a la página cuando ganó; el original
// se borró con el resto de los laboratorios, así que ésta es hoy la única
// versión.
//
// ── De dónde sale ─────────────────────────────────────────────────────────
//
