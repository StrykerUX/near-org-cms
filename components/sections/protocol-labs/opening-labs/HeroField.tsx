...
//
// Salió de dentro de `OpeningE` cuando `combo-labs/` necesitó montarlo con otras
// secciones 2 y 3. `OpeningE` lo importa desde acá: es la misma pieza y no una
// copia, así que las dos rutas que lo muestran no pueden divergir.
