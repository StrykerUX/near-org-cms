    ...
    <section ref={rootRef} className="bg-cream py-20 lg:py-28">
      <Container className="flex flex-col gap-16">
        {/* El salto después de "for" es
            ...
            `PROOF_HEADLINE` lo comparten las tres propuestas (la B lo
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:items-center">
          {/* Este cuerpo —titular acentuado, contadores en lista y gráfica
              al lado— es el mismo de la propuesta A, traído entero por
              pedido. Lo que C conserva de lo suyo es el PIE: el strip de
              logos en carrusel, más abajo. La B se quedó con su fila
              compacta y su gráfica a ancho completo.
        ...
        {/* Lo que distingue a esta propuesta de la B: el strip corre en
