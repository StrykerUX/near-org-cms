// La copy de /prototype/homepage-v2, fuera de los componentes que la pintan.
//
...
// ── de NavPillV2.tsx ──
export const NAV_LINKS = [{ label: "For Founders" }, { label: "For Developers" }, { label: "Tech Stack" }];
