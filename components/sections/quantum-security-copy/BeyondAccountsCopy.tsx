...
//
// Duplicado de BeyondAccounts.tsx para iterar sobre esta copia sin tocar el
// original — mismo patrón que las variantes de Comparison en esta carpeta.

export default function BeyondAccountsCopy() {
