// La copy de /prototype/homepage-a, fuera de los componentes que la pintan.
//
...
// El arte vive en `public/prototype/homepage-a/` y no en `public/prototype/`, que es
