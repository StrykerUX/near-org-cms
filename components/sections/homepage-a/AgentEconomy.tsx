...
import { BEATS, onSequence } from "@/components/sections/homepage-a/heroSequence";
import { AGENT_ECONOMY as COPY } from "@/components/sections/homepage-a/homepageUpdateContent";
      ...
      <Container>
        ...
        <div className="@container">
          ...
          <div className="mx-auto flex w-fit items-baseline gap-[0.52em] text-manifesto">
            ...
            <Image
              data-agent-slot
              src="/prototype/homepage-a/near-icon.svg"
              alt=""
              aria-hidden="true"
              width={800}
              height={800}
