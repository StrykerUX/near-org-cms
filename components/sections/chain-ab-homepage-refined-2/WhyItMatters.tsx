...
// Misma ESTRUCTURA de 3 columnas de la referencia (regla fina arriba, ícono
// chico, título, cuerpo, escalera vertical por columna) que la primera
// vuelta de esta sección — lo único que cambia acá es la piel: fondo claro
// (`bg-cream`, texto oscuro) en vez de oscuro, pedido explícito. Mismo copy
// e íconos de siempre (`WHY_IT_MATTERS`, `icon-*.webp`), ningún dato nuevo.
const ICONS = [
